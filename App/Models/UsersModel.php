...
class UsersModel extends Model {
    //We don't write for example:     $this->db->fetchAll('users');     but we write   $this->fetchAll('users');    because of the  __call() function in Model.php
     ...
     */
    public function all() {
        return $this->fetchAll('users');//We didn't write     $this->db->fetchAll('users');    because of the  __call() function in Model.php
